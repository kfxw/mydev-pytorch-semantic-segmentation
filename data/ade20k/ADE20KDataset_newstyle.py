...
class ADE20KTrainDataset(torchdata.Dataset):
	...
	if self.random_scale == True:
		...
		transforms.Normalize(mean=[0.481457647, 0.454692157, 0.403843529], std=[0.5, 0.5, 0.5]) ])
...
class ADE20KValDataset(torchdata.Dataset):
...
class ADE20KTestDataset(torchdata.Dataset):
